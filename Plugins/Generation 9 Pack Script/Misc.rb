...
# #===============================================================================
# # New Temp Pokemon Parameter
# #===============================================================================
# class Pokemon
#   attr_accessor :rage_hit, :activedAbility
#   # Variable to keep the hit count
#   def rage_hit ; @rage_hit = 0 if !@rage_hit ; return @rage_hit ;  end
#   def activedAbility ; @activedAbility = false if !@activedAbility ; return @activedAbility ;  end
# end
