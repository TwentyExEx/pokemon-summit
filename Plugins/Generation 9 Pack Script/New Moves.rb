...
#===============================================================================
# Counters a move used against the user this round, with 1.5x the power.
# (Comeuppance)
#===============================================================================
class Battle::Move::CounterAnyCategoryDamage < Battle::Move::FixedDamageMove
  def pbAddTarget(targets, user)
    t = user.effects[PBEffects::ComeuppanceTarget]
  ...
  def pbFixedDamage(user, target)
    dmg = user.effects[PBEffects::Comeuppance] * 1.5
    dmg = 1 if dmg == 0
    return dmg
  end
end
...
#===============================================================================
# Increase 50 Damage for each fainted members
# (Last Respect)
#===============================================================================
...
# (Make It Rain)
#===============================================================================
class Battle::Move::AddMoneyGainedFromBattleLowerUserSpAtk1 < Battle::Move::AddMoneyGainedFromBattle
  def pbEffectGeneral(user)
    super
    user.pbLowerStatStage(:SPECIAL_ATTACK, 1, user, true) if user.pbCanLowerStatStage?(:SPECIAL_ATTACK, user, self)
  end
end
#===============================================================================
...
# (Spicy Extract)
#===============================================================================
class Battle::Move::RaiseLowerTargetStat < Battle::Move
...
#===============================================================================
# Decreases the user's Speed by 2 stage. (Spin Out)
#===============================================================================
...
# category. (Tera Blast)
#===============================================================================
class Battle::Move::CategoryDependsOnHigherDamageTeraType < Battle::Move
  def initialize(battle, move)
    super
    @calcCategory = 1
  end
...
#===============================================================================
# Raises user's Sp Attack if not holding a Throat Spray. (Torch song)
#===============================================================================
class Battle::Move::RaiseUserSpAtk1TorchSong < Battle::Move::RaiseUserSpAtk1
  def pbAdditionalEffect(user, target)
    super if user.item != :THROATSPRAY
  end
end
#===============================================================================
