...
def pbSummitInitShopItems
  ...
  utilitems = [:ABILITYSHIELD, :AIRBALLOON, :ASSAULTVEST, :BIGROOT, :BINDINGBAND, :BLUNDERPOLICY, :BRIGHTPOWDER, :CHOICEBAND, :CHOICESCARF, :CHOICESPECS, :CLEARAMULET, :COVERTCLOAK, :CRASHGEAR, :DAMPROCK, :DESTINYKNOT, :EJECTBUTTON, :EJECTPACK, :ELECTRICSEED, :EXPERTBELT, :EXTENDEDBOOKING, :FLAMEORB, :FLOATSTONE, :FOCUSBAND, :FOCUSSASH, :GRASSYSEED, :GRIPCLAW, :HEARTSCALE, :HEATROCK, :HEAVYDUTYBOOTS, :HOMINGBLASTER, :ICYROCK, :IRONBALL, :IRONDENTURE, :KARATEBAND, :KINGSROCK, :KNIFESHARPENER, :LAGGINGTAIL, :LEEK, :LEFTOVERS, :LIFEORB, :LIGHTCLAY, :LOADEDDICE, :LUCKINCENSE, :MAGNIFYINGGLASS, :MENTALHERB, :METRONOME, :MIRRORHERB, :MISTYSEED, :MUSCLEBAND, :POWERHERB, :PROTECTIVEPADS, :PSYCHICSEED, :PUNCHINGGLOVE, :QUICKCLAW, :RAZORCLAW, :RAZORFANG, :REDCARD, :RINGTARGET, :ROCKYHELMET, :ROOMSERVICE, :SAFETYGOGGLES, :SCOPELENS, :SHEDSHELL, :SHELLBELL, :SMOKEBALL, :SMOOTHROCK, :STICKYBARB, :SUPPRESSORVEST, :TERRAINEXTENDER, :THICKCLUB, :THROATSPRAY, :TOXICORB, :UTILITYUMBRELLA, :WEAKNESSPOLICY, :WHITEHERB, :WIDELENS, :WINDTURBINE, :WISEGLASSES, :ZOOMLENS]
