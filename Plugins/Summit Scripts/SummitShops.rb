...
def pbSummitInitShopItems
  ...
  utilitems = [:ABILITYSHIELD, :AIRBALLOON, :ASSAULTVEST, :BIGROOT, :BINDINGBAND, :BLUNDERPOLICY, :BRIGHTPOWDER, :CHOICEBAND, :CHOICESCARF, :CHOICESPECS, :CLEARAMULET, :COVERTCLOAK, :CRASHGEAR, :DAMPROCK, :DESTINYKNOT, :EJECTBUTTON, :EJECTPACK, :ELECTRICSEED, :EXPERTBELT, :EXTENDEDBOOKING, :FLAMEORB, :FLOATSTONE, :FOCUSBAND, :FOCUSSASH, :GRASSYSEED, :GRIPCLAW, :HEARTSCALE, :HEATROCK, :HEAVYDUTYBOOTS, :HOMINGBLASTER, :ICYROCK, :IRONBALL, :IRONDENTURE, :KARATEBAND, :KINGSROCK, :SHARPENINGSTONE, :LAGGINGTAIL, :LEEK, :LEFTOVERS, :LIFEORB, :LIGHTCLAY, :LOADEDDICE, :LUCKINCENSE, :MAGNIFYINGGLASS, :MENTALHERB, :METRONOME, :MIRRORHERB, :MISTYSEED, :MUSCLEBAND, :POWERHERB, :PROTECTIVEPADS, :PSYCHICSEED, :PUNCHINGGLOVE, :QUICKCLAW, :RAZORCLAW, :RAZORFANG, :REDCARD, :RINGTARGET, :ROCKYHELMET, :ROOMSERVICE, :SAFETYGOGGLES, :SCOPELENS, :SHEDSHELL, :SHELLBELL, :SMOKEBALL, :SMOOTHROCK, :STICKYBARB, :SUPPRESSORVEST, :TERRAINEXTENDER, :THICKCLUB, :THROATSPRAY, :TOXICORB, :UTILITYUMBRELLA, :WEAKNESSPOLICY, :WHITEHERB, :WIDELENS, :WINDTURBINE, :WISEGLASSES, :ZOOMLENS]
    $game_variables[39] = utilitems
  berries = [:CHERIBERRY, :CHESTOBERRY, :PECHABERRY, :LUMBERRY, :RAWSTBERRY, :ASPEARBERRY, :PERSIMBERRY, :SITRUSBERRY, :OCCABERRY, :PASSHOBERRY, :WACANBERRY, :RINDOBERRY, :YACHEBERRY, :CHOPLEBERRY, :KEBIABERRY, :SHUCABERRY, :COBABERRY, :PAYAPABERRY, :TANGABERRY, :CHARTIBERRY, :KASIBBERRY, :HABANBERRY, :COLBURBERRY, :BABIRIBERRY, :CHILANBERRY, :ROSELIBERRY, :LEPPABERRY]
