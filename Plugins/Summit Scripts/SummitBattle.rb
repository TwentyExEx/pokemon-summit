...
def pbSummitMainTrainer
  ...
  if $game_variables[35] == "challenge" || $game_variables[35] == "gauntlet"
    ...
    case $game_variables[48] # Scaling Stage
    when 0
      ivset = 15
      evset = false
      nature = "neutral"
  ...
  trainer = GameData::Trainer.get(type.to_sym, name, version).to_trainer
...
def pbSummitPrepBattle
  ...
  for poke in $Trainer.party
    ...
    clonepoke.tera_type = poke.tera_type
    for j in 0...6
