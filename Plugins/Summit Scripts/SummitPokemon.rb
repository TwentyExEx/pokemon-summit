$allpkmn = [
  ...
  [:SIMISAGE, :SEEDBOMB, :BRICKBREAK, :ROCKSLIDE, :GUNKSHOT, 0, 0],
  [:SIMISEAR, :WILLOWISP, :FLAMETHROWER, :ACROBATICS, :SHADOWCLAW, 0, 0],
  [:SIMIPOUR, :NASTYPLOT, :SURF, :ICEBEAM, :GRASSKNOT, 0, 0],
