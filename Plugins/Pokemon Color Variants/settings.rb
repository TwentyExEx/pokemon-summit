...
module PokemonColorVariants
  ...
  HUE_POKEMON_CHANCE = 0   # default: 256 (256/65536 = 1/256)
  ...
  SUPER_SHINY_ONLY = true # Apply hue shift only on super shiny pokemons
  ...
  CHECK_FOR_UPDATES = false  # Check if there is an updated version of the script
end
